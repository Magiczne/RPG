...
namespace UI
{
	public ref class WinFormsUserInterface
	...
	public:
		...
		/// </summary>
		static property WinFormsUserInterface^ Instance
		{
			WinFormsUserInterface^ get();
		}

	private:
		static WinFormsUserInterface _instance;

		WinFormsUserInterface();
		WinFormsUserInterface(const WinFormsUserInterface%);
	};
}